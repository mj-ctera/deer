...
WordPress version: required at least 4.7, tested up to 6.4.2
...
Please install and activate it before starting to use the theme Equadio.
...
Theme documentation is available on https://equadio.themerex.net/doc/
...
2) Icons (css/font-icons/*.*)
   The icon set used in Equadio is Fontello.
