		...
		#>><#
            ...
            #><div class="sc_price_item_info"><#                                          
                if (item.title != '' || item.price != '')  {
                    #><div class="sc_price_item_title_wrap"><# 
                        if (item.title != '') {
            ...
            #></div><#                                         
			if (item.image.url != '') {
				#><div class="sc_price_item_image"><img src="{{ item.image.url }}" alt="<?php esc_attr_e('Icon', 'equadio'); ?>"></div><#
			} else {
			...
			#><div class="sc_price_item_details_wrap"><#
				if (item.details != '') {
			...
			#></div><!-- /.sc_price_item_details_wrap --><#
			if (item.bg_image.url != '' || item.bg_color != '') {
