		...
		if ( has_post_thumbnail() && $args['featured']=='image') {
			trx_addons_get_template_part('templates/tpl.featured.php',
											...
											apply_filters('trx_addons_filter_args_featured', array(
															...
															'thumb_size' => apply_filters('trx_addons_filter_thumb_size', trx_addons_get_thumb_size($args['columns'] > 2 ? 'medium' : 'big'), 'services-alter'),
															'no_links' => empty($link),
															'link' => $link,
	...
	<div class="sc_services_item_info">
		...
		<div class="sc_services_item_header"><?php
            ...
            if ($args['featured']=='number') {
                ?><span class="sc_services_item_number"><?php printf($number . '.');?></span><?php
            }
			$title_tag = $args['featured']=='number' ? 'h4' : 'h6';
			if ((isset($args['show_subtitle']) && (int)$args['show_subtitle'] == 1) && ($args['featured']=='number' && $args['featured_position']=='top')) {
