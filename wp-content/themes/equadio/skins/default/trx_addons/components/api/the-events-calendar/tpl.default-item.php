    ...
    <div class="sc_events_item_info_wrap">
        <div class="sc_events_item_info">
            <div class="sc_events_item_header"><?php
                ...
                ?></div>
                <?php if ( ( isset ( $args['show_excerpt'] ) && ( (int)$args['show_excerpt'] == 1 ) ) && ( $excerpt = get_the_excerpt() ) != '' ) { ?>
        ...
        <?php if (!empty($args['more_text'])) { ?>
            <div class="sc_events_item_button sc_item_button">
                <a href="<?php echo esc_url($post_link); ?>" class="<?php echo esc_attr(apply_filters('trx_addons_filter_sc_item_link_classes', 'sc_button sc_button_size_small', 'sc_events', $args)); ?>">
