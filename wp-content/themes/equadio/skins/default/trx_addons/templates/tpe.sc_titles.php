...
var svg_bg_dir = '<?php echo equadio_get_svg_from_file(equadio_get_file_dir('images/brushstroke2.svg')); ?>';
	...
	title_html += '<' + title_tag + ' class="'
					...
					+ (settings.title_style == 'gradient'
						? '<span class="trx_addons_text_gradient"'
							...
							+ '</span>'
						: ( settings.title_style == 'decoration'
                             ? ( '<span class="sc_item_title_text_wrap">'
...
if (settings.description) {
	title_html += '<div class="' + description_class + title_align + title_style + '">'
