...
$svg_bg_dir = equadio_get_svg_from_file(equadio_get_file_dir('images/brushstroke2.svg'));
	...
	?><<?php echo esc_attr($title_tag); ?> class="<?php 
		...
		if ($args['title_style'] == 'gradient') {
			echo '<span class="trx_addons_text_gradient sc_item_title_text"'
					...
					. '</span>';
		} else	if  ($args['title_style'] == 'decoration') {
              echo  '<span class="sc_item_title_text_wrap">'
